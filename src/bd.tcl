...
proc create_root_design { parentCell } {
  ...
  # Create instance: data_copier_0, and set properties
  set block_name data_copier
  set block_cell_name data_copier_0
  if { [catch {set data_copier_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $data_copier_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_smc/M01_AXI]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins data_copier_0/bram0_din]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net data_copier_0_bram0_addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins data_copier_0/bram0_addr]
  connect_bd_net -net data_copier_0_bram0_wen [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins data_copier_0/bram0_wen]
  connect_bd_net -net data_copier_0_bram1_addr [get_bd_pins axi_bram_ctrl_0_bram1/addrb] [get_bd_pins data_copier_0/bram1_addr]
  connect_bd_net -net data_copier_0_bram1_dout [get_bd_pins axi_bram_ctrl_0_bram1/dinb] [get_bd_pins data_copier_0/bram1_dout]
  connect_bd_net -net data_copier_0_bram1_wen [get_bd_pins axi_bram_ctrl_0_bram1/web] [get_bd_pins data_copier_0/bram1_wen]
  connect_bd_net -net data_copier_0_bram_en [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins axi_bram_ctrl_0_bram1/enb] [get_bd_pins data_copier_0/bram_en]
  connect_bd_net -net data_copier_0_bram_rst [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins axi_bram_ctrl_0_bram1/rstb] [get_bd_pins data_copier_0/bram_rst]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_bram_ctrl_0_bram1/clkb] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins data_copier_0/clk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0002000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
